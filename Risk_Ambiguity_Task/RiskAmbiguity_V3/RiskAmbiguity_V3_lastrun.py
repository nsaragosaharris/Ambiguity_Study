...
expName = 'RiskAmbiguity_V3'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\SAND Lab\\Desktop\\CTS\\Lab Session\\Chips Task\\RiskAmbiguity_V3\\RiskAmbiguity_V3.psyexp',
...
choicetrials = data.TrialHandler(nReps=1, method='random', 
    extraInfo=expInfo, originPath='C:\\Users\\SAND Lab\\Desktop\\CTS\\Lab Session\\Chips Task\\RiskAmbiguity_V3\\RiskAmbiguity_V3.psyexp',
    trialList=data.importConditions('RiskAmbiguity_ConditionFile_V3.xlsx'),
